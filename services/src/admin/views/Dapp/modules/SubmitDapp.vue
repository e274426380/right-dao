<template>
  ...
  <div class="dapp-wrapper">
    <el-form :model="dappForm" class="el-form-detail" ref="dappForm" label-width="100px" label-position="right" v-loading="loading">
      ...
      <template>
        <el-form-item label="编辑DAPP" class="form-item-title" label-width="200px">
      ...
      <el-form-item>
        ...
        <!--</template>-->
        <template>
          <el-button style="margin-top:50px" class="form-btn btn-submit" @click="submitForm('dappForm')">提交修改</el-button>
          <el-button class="form-btn btn-cancel" @click="$router.back(1)">返回</el-button>
        </template>
